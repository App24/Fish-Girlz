...
namespace Fish_Girlz.Inventory{
    public class Slot {
        ...
        internal Slot(Item item, int amount):this(item, amount, typeof(Item)){
        }

        internal Slot(Item item, int amount, Type allowedItemType){
            Item=item;
            Amount=amount;
            AllowedItemType=allowedItemType;
        }

        internal bool SetItem(Item item){
        ...
        internal int IncreaseAmount(int amount=1){
            Amount+=amount;
        ...
        internal int DecreaseAmount(int amount=1){
            Amount-=amount;
